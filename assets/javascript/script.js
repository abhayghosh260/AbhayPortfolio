...
$(document).ready(function () {
    ...
    $('.vdo3').magnificPopup({
        items: {
            src: 'assets/videos/short-reel.mp4'
        },
        type: 'iframe'
    });
    ...
    $('.vdo5').magnificPopup({
        items: {
            src: 'assets/videos/faceless.mp4'
        },
        type: 'iframe'
    });
